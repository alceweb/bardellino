<%@ Page Title="Modifica offerta" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="OffEdit.aspx.cs" Inherits="Admin_OffEdit" %>
    ...
    <table>
        <tr>
            <td>
                <asp:ListView ID="ListView1" runat="server" DataKeyNames="Id" SelectedIndex="0" DataSourceID="SqlDataSource1">
                    <EmptyDataTemplate>
                        <table id="Table1" runat="server" style="">
                            <tr>
                                <td>Non ci sono offerte nel database.</td>
                            </tr>
                        </table>
                    </EmptyDataTemplate>
                    <ItemTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT * FROM [baoff] ORDER BY [DataInizio] DESC"></asp:SqlDataSource>
            </td>
            <td>
                <asp:ListView ID="ListView2" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource2">
                    <ItemTemplate>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="OffertaLabel" runat="server" Text='<%# Eval("Offerta") %>' /><hr />
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" DeleteCommand="DELETE FROM [baoff] WHERE [Id] = @Id" InsertCommand="INSERT INTO [baoff] ([DataInizio], [DataFine], [Offerta], [Pubblica], [Titolo]) VALUES (@DataInizio, @DataFine, @Offerta, @Pubblica, @Titolo)" SelectCommand="SELECT * FROM [baoff] WHERE ([Id] = @Id)" UpdateCommand="UPDATE [baoff] SET [DataInizio] = @DataInizio, [DataFine] = @DataFine, [Offerta] = @Offerta, [Pubblica] = @Pubblica, [Titolo] = @Titolo WHERE [Id] = @Id">
                    <DeleteParameters>
